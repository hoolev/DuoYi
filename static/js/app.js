...
function ($routeProvider, $locationProvider, newVersionProvider) {
    ...
    when('/welcome', {
        templateUrl: newVersionProvider.get('/static/tpl/welcome.html'),
        //controller: 'menuCtrl'
    }).
   // when('/menu:ID', {
   //     templateUrl: newVersionProvider.get('/static/tpl/menu.html'),
   //     controller: 'menuCtrl'
   // }).
    when('/M:name', {
        templateUrl: newVersionProvider.get('/static/tpl/menu.html'),
        controller: 'menuCtrl'
        //templateUrl: newVersionProvider.get('/static/tpl/cart-list.html'),
    ...
    when('/:name', {
        templateUrl: newVersionProvider.get('/static/tpl/dishes.html'),
